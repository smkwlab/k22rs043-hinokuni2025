...
\newcommand{\maru}[1]{%
  ...
  \dimen0=\wd0%
  \unitlength=1pt%
  \begin{picture}（10,10）（0,2）%
    \put（5,5）{\circle{10}}%
    \put（5,5）{\makebox（0,0）{\scalebox{0.75}{#1}}}%
  \end{picture}%
  \endgroup%
}
...
我々の研究室ではこれを支援するシステム「サポちゃん」\cite{bib:densi2016,bib:forum2017,bib:hinokuni2017,bib:hinokuni2018,bib:hinokuni2022}を開発してきたが,管理者向け機能が未整備で,データベースを直接操作する必要があり,運用負担やヒューマンエラーのリスクが課題であった．
...
その他にもSAやTA・教員用画面の機能不足,クォーター制への未対応,授業情報の一括登録不可など,運用上の課題が多く存在する．

そこで本研究では,サポちゃんにおける管理者の運用負担の軽減を目的とし,管理者機能を開発する．
また、その他の運用上の課題を解決するために、機能を改良・新たに追加する．
...
\bibitem{bib:hinokuni2017} 
早川諒，古井陽之助，神屋郁子，下川俊彦：講義における演習状況把握システムの開発，火の国シンポジウム2017（2017）.

\bibitem{bib:forum2017} 
野中優，古井陽之助，下川俊彦，神屋郁子：教室でのPCを活用した演習支援システムの開発，第16回情報科学技術フォーラム（2017）.

\bibitem{bib:hinokuni2018}
神屋郁子，石飛伊織，古井陽之助，下川俊彦：演習状況把握システムの開発，火の国シンポジウム2018（2018）.
